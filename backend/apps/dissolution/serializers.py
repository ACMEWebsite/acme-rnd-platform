...
class DissolutionSimulationSerializer(serializers.Serializer):
    mode = serializers.CharField(required=False, default="standard")
    ...
    log_s = serializers.FloatField(min_value=-20, max_value=5, required=False, default=-3.0)
    ...
    # PBBM specific fields
    s0_mg_ml = serializers.FloatField(min_value=0.00001, max_value=1000, required=False, default=0.05)
    pka = serializers.FloatField(required=False, allow_null=True, default=4.45)
    ion_type = serializers.CharField(required=False, default="acid")
    peff_cm_s = serializers.FloatField(min_value=0.000001, max_value=0.01, required=False, default=0.00015)
    cl_l_hr = serializers.FloatField(min_value=0.01, max_value=1000, required=False, default=6.0)
    vc_l = serializers.FloatField(min_value=0.1, max_value=1000, required=False, default=12.0)
    duration_hr = serializers.FloatField(min_value=0.1, max_value=168, required=False, default=24.0)
